...
public class WifiListRowItem implements Comparable<WifiListRowItem>{
	...
	public void setDoubleDistance(double distance) {
	...
	@Override
	public int compareTo(WifiListRowItem obj) {
